...
namespace _09_Portfolio
{
    ...
    public class PolymorphismTests
    {
        ...
        public void CD()
        {
            SavingsAccount cd = new SavingsAccount("Account 55555", 1000.2, 4.2);
            Assert.IsTrue(cd is IAsset);
            Assert.AreEqual("SavingsAccount[value=1000,2,interestRate=4,2]", cd.ToString());
            Assert.AreEqual(1000.2, cd.GetValue());
